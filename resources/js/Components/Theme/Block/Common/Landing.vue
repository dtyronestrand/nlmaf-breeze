...
<template>
    ...
    <FallingStarsBackground class="bg-black"/>
    ...
    >
    <span class="flex flex-col items-center justify-center bg-gradient-to-b from-[var(--color-neutral-200)] to-[var(--color-neutral-500)] bg-clip-text text-center text-4xl font-bold text-transparent md:text-6xl"><span>Are You Ready to Start Your<FlipWords
    :words="['Change', 'Routine', 'Journey']"
    :duration="3000"
    class="w-52 bg-gradient-to-b from-[var(--color-neutral-200)] to-[var(--color-neutral-500)] bg-clip-text text-transparent"/>
    </span></span>
   ...
   <p class="text-center mt-2">{{ child.content.details }}</p>
    ...
    <IconButton class="mt-4 text-[var(--color-neutral-900)]" @click="router.get(child.content.link)" >Learn More</IconButton>
    </div>

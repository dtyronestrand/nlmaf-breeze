...
.gradient-background {
    ...
    --color-accent-200: #fbef9f;
    background: linear-gradient(120deg, #c0392b, #f2c1be);
            top: -10%;
            left: -10%;
        ...
        .sphere-2 {
            width: 45vw;
            height: 45vw;
            background: linear-gradient(240deg,#e67e22, #f6c9a5);
            bottom: -20%;
            right: -10%;
        ...
        .sphere-3 {
            ...
            background: linear-gradient(40deg, #f4d03f, #fbef9f);
            top: 60%;
            left: 20%;
